...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "ejmarten-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/spring"
  #   chef.validation_client_name = "spring-validator"
  #   chef.validation_key_path = ".chef/spring-validator.pem"
  # end
end
